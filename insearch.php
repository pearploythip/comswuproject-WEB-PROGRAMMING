...
function loadJSON(str)
{
	...
	if (xmlhttp.readyState == 4 && xmlhttp.status==200)
    {
	  ...
	  if(obj.success && obj.num >0) {
		...
		document.getElementById('Ingredient').innerHTML=txt;
    }
  }
xmlhttp.open("GET","bsearch.php?fname="+str,true);
xmlhttp.send();
}
</script>
</head>
<body>
Search Ingredient <input type="text" name="fname" onkeyup="loadJSON(this.value)"><br/>
</form>
<br>
<div id="Ingredient"><b>Insert Ingredient</b></div>
</body>
</html>