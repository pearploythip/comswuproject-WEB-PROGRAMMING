...
mysql_connect("10.1.3.40","57102010282","57102010282") or die("<center><h1 style=\"color:#E9A72B;\">SERVER FAILED</h1></center>");
	...
	$strSQL = "SELECT * FROM menu WHERE Type = 'International' ORDER BY Name ASC Limit $start_page,$row";
        ...
        <div class="row">
            <div class="box">
				...
				<?php if(isset($_SESSION["Fullname"])){
                     ...
                     <h1 class="brand-before text-center">
                        <strong> International Menu List </strong> 
                    </h1>
    ...
    <?php
     ...
     <div class="event-page">
             ...
             <ul class="table-list"><li class="clearfix">
	       	 	...
	       	 	<h2><a href="show3.php?sh=<?php echo $objResult["Idmenu"];?>"><?php echo $objResult["Name"];?></a>
                    </h2>
